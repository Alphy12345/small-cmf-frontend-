...
const ProjectCreation = () => {
  ...
  // Reset current page when search query or sort order changes
  useEffect(() => {
    setCurrentPage(1);
            ...
            <div className="recent-projects-grid">
              {recentProjects.map((project) => (
                ...
                >
                  ...
                  <span className="recent-project-no">{safeValue(project.project_number || project.id)}</span>
                </div>
              ))}
            </div>
          </section>
              ...
              {totalPages > 1 && (
                <div className="pagination-controls">
                  <div className="pagination-info">
                    Showing {((currentPage - 1) * projectsPerPage) + 1} to {Math.min(currentPage * projectsPerPage, filteredAndSortedProjects.length)} of {filteredAndSortedProjects.length} projects
                  </div>
