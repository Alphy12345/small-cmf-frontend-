               ...
               (!currentProject.directParts || currentProject.directParts.length === 0) ? (
                ...
                <div style={{ padding: '1rem', display: 'flex', flexDirection: 'column', height: '100%' }}>
                  <div style={{ 
                    ...
                    <div style={{ fontSize: '0.75rem', color: '#9ca3af' }}>
                      Start by adding an assembly or direct parts
                    </div>
                  </div>
                ...
                <>
                  ...
                  <div>
                    <div style={{ display: 'flex', alignItems: 'center', background: '#667eea', padding: '0.75rem 1rem', color: 'white', fontWeight: '600', fontSize: '0.875rem', textTransform: 'uppercase' }}>
                      <div 
                  ...
                  {(currentProject.directParts && currentProject.directParts.length > 0) && (
                    <div style={{ marginTop: '0.5rem' }}>
                      <div onClick={() => toggleNode('direct-parts')} style={{ padding: '0.75rem 1rem', background: '#10b981', color: 'white', fontWeight: '600', fontSize: '0.875rem', textTransform: 'uppercase', display: 'flex', alignItems: 'center', justifyContent: 'space-between', cursor: 'pointer' }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                                          ...
                                          <div style={{ 
                                            ...
                                            <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                                              <div style={{ 
                                                ...
                                                <FileText size={20} style={{ animation: 'bounce 1.5s infinite' }} />
                                              </div>
                                              <div style={{ flex: 1, minWidth: 0 }}>
                                                <div style={{ 
                                                  fontWeight: '600', 
                                          ...
                                          <div style={{ 
                                            ...
                                            <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                                              <div style={{ 
                                                ...
                                                <Package size={20} style={{ animation: 'rotate 3s linear infinite' }} />
                                              </div>
                                              <div style={{ flex: 1, minWidth: 0 }}>
                                                <div style={{ 
                                                  fontWeight: '600', 
              ...
              <button 
               ...
               disabled={!modalData.name.trim() || (modalData.type === 'part' && !modalData.isDirectPart && (!modalData.pdfFile || !modalData.stepFile))}
                style={{ 
                  ...
                  opacity: !modalData.name.trim() || (modalData.type === 'part' && (!modalData.pdfFile || !modalData.stepFile)) ? 0.6 : 1,
                  fontWeight: '500',
                  transition: 'all 0.2s'
                }}
              >
                {assemblyLoading ? (
                  <span style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                    ...
                    {modalData.editId ? 'Updating...' : 'Creating...'}
                  </span>
                ) : (
          ...
          >
            ...
            <div style={{
              ...
              <h3 style={{ margin: 0, fontSize: '1.25rem', fontWeight: '600', color: '#111827' }}>
                Upload New Version - {newVersionDoc.title}
              </h3>
              <button
                onClick={() => {
                  setShowNewVersionModal(false);
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                    <div>
                      ...
                      <p style={{ margin: 0, fontSize: '0.875rem', color: '#6b7280' }}>
                        Version: {newVersionDoc.version || 'Current'} • 
                        Uploaded: {newVersionDoc.uploadedAt ? new Date(newVersionDoc.uploadedAt).toLocaleDateString() : 'Unknown'}
                      </p>
                    </div>
                    <div style={{ display: 'flex', gap: '0.5rem' }}>
                      <button
                        onClick={() => {
                          if (newVersionDoc.download_url) {
                            window.open(`http://172.18.100.26:8987${newVersionDoc.download_url}`, '_blank');
                          }
                        }}
                        style={{
                          padding: '0.5rem 1rem',
                      ...
                      <button
                        onClick={() => setPreviewDoc({ doc: newVersionDoc, type: newVersionDoc.file_format === 'pdf' ? '2D' : '3D' })}
                        style={{
                          padding: '0.5rem 1rem',
                          border: '1px solid #d1d5db',
                          borderRadius: '6px',
                  ...
                  {newVersionFile ? (
                    <div>
                      ...
                      <p style={{ margin: '0 0 1rem 0', fontSize: '0.875rem', color: '#6b7280' }}>
                        Size: {(newVersionFile.size / 1024 / 1024).toFixed(2)} MB
                      </p>
                      <button
                    ...
                    <div>
                      ...
                      <p style={{ margin: '0 0 1.5rem 0', fontSize: '0.875rem', color: '#6b7280' }}>
                        {newVersionDoc.file_format === 'pdf' ? 'PDF files only' : 'STEP files (.step, .stp)'}
                      </p>
                      <input
                        type="file"
            ...
            <div style={{
              ...
              <button
                ...
                disabled={!newVersionFile || !newVersionName.trim() || !newVersionNumber.trim() || uploadingNewVersion}
                style={{
                  padding: '0.75rem 1.5rem',
                  border: 'none',
                  borderRadius: '6px',
                  backgroundColor: (!newVersionFile || !newVersionName.trim() || !newVersionNumber.trim() || uploadingNewVersion) ? '#9ca3af' : '#10b981',
                  color: '#ffffff',
                  fontSize: '0.875rem',
                  fontWeight: '500',
                  cursor: (!newVersionFile || !newVersionName.trim() || !newVersionNumber.trim() || uploadingNewVersion) ? 'not-allowed' : 'pointer',
                  display: 'flex',
                  alignItems: 'center',
                  gap: '0.5rem'
                }}
